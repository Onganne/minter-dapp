...
const CONTRACT_NAME = 'Souless Scrubs';
const CONTRACT_SYMBOL = 'SS1';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = '0x2d76393bD52C40A0b8e32fCdbA36A36320F7a43C';
const TREASURY_ADDRESS = '0x2d76393bD52C40A0b8e32fCdbA36A36320F7a43C';
const MAX_SUPPLY = 5000; // The maximum number of NFTs that can be minted. CANNOT BE UPDATED!
const MINT_PRICE = 0.00333; // Minting price per NFT. Rinkeby = ETH, Polygon = MATIC. CANNOT BE UPDATED!
const TOKENS_PER_MINT = 2; // maximum number of NFTs a user can mint in a single transaction. CANNOT BE UPDATED!

// REQUIRED CONTRACT DETAILS THAT CAN BE UPDATED LATER.
const PUBLIC_MINT_START_DATE = "2022-03-01T11:00:00+08:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00

// OPTIONAL CONTRACT DETAILS THAT CAN BE UPDATED LATER.
const PRESALE_MINT_START_DATE = null; // Optional. Eg: 2022-02-08T11:30:48+00:00
const ROYALTY_SHARE = 500; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0x2d76393bD52C40A0b8e32fCdbA36A36320F7a43C"; // Address that will receive the royalty
...
const GENERIC_DESCRIPTION = "Which is the Scrub that you will adopt? WIll you even show acceptance?"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeicux5qa7gzohw2mxtty7azgmnjwi45zfy6g2pvgvragdb6okkwl4u"; // Replace with your generic image that will display for all NFTs pre-reveal.
